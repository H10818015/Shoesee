...
public class MainPage extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener{
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        DrawerAdapter adapter = new DrawerAdapter(Arrays.asList(
                ...
                createItemFor(POS_IDENTIFY),
               // createItemFor(POS_SHOPPING_CART),
